...
- A page context-menu action opens toolbar search. An English-word selection is
  handed to that popup once and looked up immediately; other contexts stay manual.
